// Plugin
#include "rs485_hardware_cpp/rs485_system_hardware.hpp"
...
namespace rs485_hardware_cpp
{

static inline double deg2rad(double deg) { return deg * M_PI / 180.0; }
static inline double rad2deg(double rad) { return rad * 180.0 / M_PI; }
/*__________________________________________________________________________________*/
std::vector<int> Rs485SystemHardware::parse_csv_ints(const std::string & s)
{
  std::vector<int> out;
...
/*__________________________________________________________________________________*/
std::vector<double> Rs485SystemHardware::parse_csv_doubles(const std::string & s)
{
...
/*__________________________________________________________________________________*/
hardware_interface::CallbackReturn Rs485SystemHardware::on_init(
  const hardware_interface::HardwareComponentInterfaceParams & params)
{
  // Chỉ giữ signature này để tránh recursion on_init(params) <-> on_init(info)
...
/*__________________________________________________________________________________*/
hardware_interface::CallbackReturn Rs485SystemHardware::on_configure(const rclcpp_lifecycle::State &)
{
  try {
...
/*__________________________________________________________________________________*/
hardware_interface::CallbackReturn Rs485SystemHardware::on_activate(const rclcpp_lifecycle::State &)
{
  if (!connected_) {
    try {
      client_.connect(port_, baudrate_, serial_timeout_s_);
...
/*__________________________________________________________________________________*/
hardware_interface::CallbackReturn Rs485SystemHardware::on_deactivate(const rclcpp_lifecycle::State &)
{
  try {
...
/*__________________________________________________________________________________*/
hardware_interface::CallbackReturn Rs485SystemHardware::on_cleanup(const rclcpp_lifecycle::State &)
{
...
/*__________________________________________________________________________________*/
std::vector<hardware_interface::StateInterface> Rs485SystemHardware::export_state_interfaces()
{
...
/*__________________________________________________________________________________*/
std::vector<hardware_interface::CommandInterface> Rs485SystemHardware::export_command_interfaces()
{
...
//#####################################################################################################################
/*__________________________________________________________________________________*/
hardware_interface::return_type Rs485SystemHardware::read(
  const rclcpp::Time &, const rclcpp::Duration &)
{
  ...
  try {
    const auto [pos_raw, vel_raw] = client_.get_pos_all(pos_timeout_s_);
...
//#####################################################################################################################
/*__________________________________________________________________________________*/
hardware_interface::return_type Rs485SystemHardware::write(
  const rclcpp::Time &, const rclcpp::Duration &)
{
  if (!connected_) return hardware_interface::return_type::ERROR;
...
PLUGINLIB_EXPORT_CLASS(rs485_hardware_cpp::Rs485SystemHardware, hardware_interface::SystemInterface)
