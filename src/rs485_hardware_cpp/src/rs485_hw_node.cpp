#include "rs485_hardware_cpp/rs485_protocol.hpp"
...
#include "rs485_hardware_cpp/srv/servo_on_axis.hpp"
#include "rs485_hardware_cpp/srv/servo_on_all.hpp"
#include "rs485_hardware_cpp/srv/jog.hpp"
#include "rs485_hardware_cpp/srv/home.hpp"
#include "rs485_hardware_cpp/srv/run_axis.hpp"
#include "rs485_hardware_cpp/srv/stop_axis.hpp"
#include "rs485_hardware_cpp/srv/stop_all.hpp"
...
using rs485_hardware_cpp::Rs485Client;
...
public:
  Rs485HwNode() : Node("rs485_hw") {
    ...
    pub_connected_    = create_publisher<std_msgs::msg::Bool>("/rs485_hw/connected", 10);
    pub_flags_ = this->create_publisher<std_msgs::msg::UInt16MultiArray>(
        "/rs485_hw/status_flags", 10);
    // ======================
    // Subscribers
    // ======================
    ...
    // Typed services
    srv_servo_on_axis_ = create_service<rs485_hardware_cpp::srv::ServoOnAxis>(
      "/rs485_hw/servo_on_axis",
      [this](const std::shared_ptr<rs485_hardware_cpp::srv::ServoOnAxis::Request> req,
             std::shared_ptr<rs485_hardware_cpp::srv::ServoOnAxis::Response> res){ on_servo_on_axis(req, res); });

    srv_servo_on_all_ = create_service<rs485_hardware_cpp::srv::ServoOnAll>(
      "/rs485_hw/servo_on_all",
      [this](const std::shared_ptr<rs485_hardware_cpp::srv::ServoOnAll::Request> req,
             std::shared_ptr<rs485_hardware_cpp::srv::ServoOnAll::Response> res){ on_servo_on_all(req, res); });

    srv_jog_ = create_service<rs485_hardware_cpp::srv::Jog>(
      "/rs485_hw/jog",
      [this](const std::shared_ptr<rs485_hardware_cpp::srv::Jog::Request> req,
             std::shared_ptr<rs485_hardware_cpp::srv::Jog::Response> res){ on_jog_srv(req, res); });

    srv_home_ = create_service<rs485_hardware_cpp::srv::Home>(
      "/rs485_hw/home",
      [this](const std::shared_ptr<rs485_hardware_cpp::srv::Home::Request> req,
             std::shared_ptr<rs485_hardware_cpp::srv::Home::Response> res){ on_home(req, res); });

    srv_run_axis_ = create_service<rs485_hardware_cpp::srv::RunAxis>(
      "/rs485_hw/run_axis",
      [this](const std::shared_ptr<rs485_hardware_cpp::srv::RunAxis::Request> req,
             std::shared_ptr<rs485_hardware_cpp::srv::RunAxis::Response> res){ on_run_axis_srv(req, res); });

    srv_stop_axis_ = create_service<rs485_hardware_cpp::srv::StopAxis>(
      "/rs485_hw/stop_axis",
      [this](const std::shared_ptr<rs485_hardware_cpp::srv::StopAxis::Request> req,
             std::shared_ptr<rs485_hardware_cpp::srv::StopAxis::Response> res){ on_stop_axis(req, res); });

    srv_stop_all_ = create_service<rs485_hardware_cpp::srv::StopAll>(
      "/rs485_hw/stop_all",
      [this](const std::shared_ptr<rs485_hardware_cpp::srv::StopAll::Request> req,
             std::shared_ptr<rs485_hardware_cpp::srv::StopAll::Response> res){ on_stop_all(req, res); });
...
private:
  ...
  void on_connect(std::shared_ptr<std_srvs::srv::Trigger::Response> res) {
    try {
      ...
      rs485_hardware_cpp::ProtocolBytes p = client_.protocol();
  ...
  // ======================
  void on_servo_on_axis(const std::shared_ptr<rs485_hardware_cpp::srv::ServoOnAxis::Request> req,
                        std::shared_ptr<rs485_hardware_cpp::srv::ServoOnAxis::Response> res) {
    try {
      if (!connected()) throw std::runtime_error("Not connected");
  ...
  void on_servo_on_all(const std::shared_ptr<rs485_hardware_cpp::srv::ServoOnAll::Request> req,
                       std::shared_ptr<rs485_hardware_cpp::srv::ServoOnAll::Response> res) {
    try {
      if (!connected()) throw std::runtime_error("Not connected");
      const int token = get_parameter("all_token").as_int();
      (void)token;
  ...
  void on_jog_srv(const std::shared_ptr<rs485_hardware_cpp::srv::Jog::Request> req,
                  std::shared_ptr<rs485_hardware_cpp::srv::Jog::Response> res) {
    try {
      if (!connected()) throw std::runtime_error("Not connected");
      const uint8_t id = req->id;
  ...
  void on_run_axis_srv(const std::shared_ptr<rs485_hardware_cpp::srv::RunAxis::Request> req,
                       std::shared_ptr<rs485_hardware_cpp::srv::RunAxis::Response> res) {
    try {
      if (!connected()) throw std::runtime_error("Not connected");
      const uint8_t id = req->id;
  ...
  void on_home(const std::shared_ptr<rs485_hardware_cpp::srv::Home::Request> req,
               std::shared_ptr<rs485_hardware_cpp::srv::Home::Response> res)
  {
    try {
      if (!connected()) throw std::runtime_error("Not connected");
  ...
  void on_stop_axis(const std::shared_ptr<rs485_hardware_cpp::srv::StopAxis::Request> req,
                    std::shared_ptr<rs485_hardware_cpp::srv::StopAxis::Response> res) {
    try {
      if (!connected()) throw std::runtime_error("Not connected");
  ...
  void on_stop_all(const std::shared_ptr<rs485_hardware_cpp::srv::StopAll::Request>,
                   std::shared_ptr<rs485_hardware_cpp::srv::StopAll::Response> res) {
    try {
      if (!connected()) throw std::runtime_error("Not connected");
...
private:
  ...
  rclcpp::Service<rs485_hardware_cpp::srv::ServoOnAxis>::SharedPtr srv_servo_on_axis_;
  rclcpp::Service<rs485_hardware_cpp::srv::ServoOnAll>::SharedPtr srv_servo_on_all_;
  rclcpp::Service<rs485_hardware_cpp::srv::Jog>::SharedPtr srv_jog_;
  rclcpp::Service<rs485_hardware_cpp::srv::Home>::SharedPtr srv_home_;
  rclcpp::Service<rs485_hardware_cpp::srv::RunAxis>::SharedPtr srv_run_axis_;
  rclcpp::Service<rs485_hardware_cpp::srv::StopAxis>::SharedPtr srv_stop_axis_;
  rclcpp::Service<rs485_hardware_cpp::srv::StopAll>::SharedPtr srv_stop_all_;
