...
Nguyên tắc:
  ...
  - COMMAND: gọi service trong rs485_hardware_cpp:
...
#from rs485_hardware_cpp.msg import StatusFlags6
from std_srvs.srv import Trigger

from qtpy import QtCore, QtGui, QtWidgets


# ---- Custom services (được generate trong pkg rs485_hardware_cpp) ----
try:
    from rs485_hardware_cpp.srv import (
        ServoOnAxis,
        ServoOnAll,
        Jog,
        RunAxis,
